...
export const emailBridgeFromBroadcast = (senderName, bridgeName) => [
  `The email this lead is replying to was a broadcast/nurture email signed by ${bridgeName}. Your reply comes from ${senderName}, a different person — open with the handoff bridge in this SHAPE: "${senderName} here — ${bridgeName} asked me to reach out because you mentioned [their point]." Replace [their point] with the specific thing THIS lead just said, paraphrased in one short clause in your own words — not quoted back, and never a generic stand-in like "your message" or "your email". If they raised a scheduling conflict, name the conflict. If they raised a concern, name the concern. Then continue in rep/company (we/our team) voice. Use the bridge ONCE — do not repeat it if the rep is already the established voice in the thread. Write as ${senderName}: ${bridgeName} is being referred to in the third person and is NEVER the author of this reply.`,
];
