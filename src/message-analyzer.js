...
An offer is not always a question. The AI-disclosure script ends "…if you'd rather talk with someone on our team, JUST SAY THE WORD and I'll have them reach out." — a real offer carrying no question mark at all, so the open-question rule above never engaged and a one-word acceptance was classified as noise. The bot promised a person and nothing happened.
• If the last outbound OFFERED to put a human in touch (any wording: "just say the word", "I can have someone reach out", "want me to get a teammate on this"), then a bare affirmative — "yes", "yes please", "sure", "please do", "that'd be great", "ok", "sounds good" — IS acceptance of that offer.
...
• DISAMBIGUATION when one outbound made the offer AND asked something else (the no-thread disclosure variant ends "…just say the word. What made you reach out today?"): a bare affirmative cannot answer an OPEN question that needs content, so it attaches to the yes/no offer, not to the open question. An inbound that actually answers the open question ("my windows are original to the house") is NOT an acceptance — classify it normally and leave the offer standing.
